 ...
 */
const char *MFRC522_I2C::GetStatusCodeName(byte code	///< One of the StatusCode enums.
										) {
	switch (code) {
 ...
 * @return const __FlashStringHelper *
 */
const char *MFRC522_I2C::PICC_GetTypeName(byte piccType	///< One of the PICC_Type enums.
										) {
	switch (piccType) {
